! function(t) {
	...
	function i(o, a, i) {
		if (!o.attr("data-comp")) {
			...
			var c = o.width(),
				...
				d = o.offset().top,
				f = o.offset().left;
			o.css("visibility", "visible"), t("body").append("<div class='meng-lazy-div" + a +
				"' style='background-color: " + r.coverColor + ";position:absolute;width:" + c + "px;height:" + e +
				"px;top:" + d + "px;left:" + f + "px;z-index:500'>" + r.coverDiv + "</div>"), n(a, i, o), o.attr(
				"data-comp", "true")
		}
	}
	...
	function c() {
		...
		l.each(function(a) {
			var n = t(this);
			n.attr("data-comp") || n.offset().top - o + r.offsetTopm >= 0 && n.offset().top - o < s + r
				.offsetBottom && i.push(a)
